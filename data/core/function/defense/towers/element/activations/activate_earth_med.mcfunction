...
$execute if score @s defense.element_random matches 1..70 as @n[tag=defense-monster] at @s run function core:defense/towers/element/wind/blow_back {"damage":"$(wind_damage)","blow_power":"$(blow_power)"}
